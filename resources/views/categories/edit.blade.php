        ...
        <div class="flex-col space-y-3 border border-gray-400 rounded rounded-lg p-6">
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" class=" flex-col space-y-3 ">
                ...
                <div class="flex  flex-col space-y-2 ">
                    ...
                    <input type="text" name="label" id="libele"
                        class="border border-gary-300 hover:bg-gray-200  rounded rounded-sm"
            ...
            {{ old('description', $category->description) }}</textarea>
                ...
                <div class="flex space-x-6">
                    <button type="submit"
                        class="flex gap-2 px-2 py-1  hover:bg-blue-400 hover:cursor-pointer w-1/2 rounded rounded-lg sm:bg-blue-500">
                        Enregistrer</button>
                    <a href="{{ route('admin.categories.index') }}"><button
                            class="flex gap-2 px-2 py-1  hover:bg-gray-200 hover:cursor-pointer w-full rounded rounded-lg sm:bg-gray-300">
                            Anuller</button></a>
                </div>
